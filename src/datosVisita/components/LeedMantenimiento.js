     ...
     <div>
       ...
       <div>
          <div className="form-group">
             ...
             <input type="text" id="oca" onChange={props.handleChange}  className="form-control" />
            ...
            <textarea className="form-control" id="observacionLeedManiento" onChange={props.handleChange} rows="3"></textarea>
           </div>
