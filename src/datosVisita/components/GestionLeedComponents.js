...
function GestionLeedComponents(props) {
  return (
    ...
    <p><strong>Direccion:</strong><input id="direccionModi" required onChange={props.handleChangeModi} className={props.cssEdicionModificar} type="text"/>  {props.direccion}</p>
