   ...
   render() {
     ...
     return (
       <tr>
         ...
         onClick={(event) => { this.handleClickReserva(event,semana[1],hora,mes[1],year[1]) }} className="btn btn-link btn-block">{reservados.indexOf(`${semana[1]} ${mes[1]} ${year[1]} ${hora}`) > - 1 ?  'Ocupado'  : 'Reservar' }</button></td>
